...
<script>
    if(<%=isSucc%> == false){
        opener.document.getElementById("loginPw").value = ""
        alert("ID 또는 비밀번호를 확인해주세요.")
    }
    else{
        var culums = <%=culums%>
        opener.document.getElementById("loginId").value = ""
        opener.document.getElementById("loginPw").value = ""
        opener.document.getElementById("loginText").innerHTML = culums[0]+"님 환영합니다."
        ...
        opener.document.getElementById("myInfo0").innerHTML = culums[0]
        opener.document.getElementById("myInfo1").innerHTML = culums[1]
        opener.document.getElementById("myInfo3").innerHTML = culums[3]
        opener.document.getElementById("myInfo4").innerHTML = culums[4]
        opener.document.getElementById("myInfo5").innerHTML = culums[5]
        opener.document.getElementById("myInfo6").value = culums[1]
    }
    self.close();
</script>