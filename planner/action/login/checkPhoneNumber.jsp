...
<%
    ...
    //SQL 만들기
    String str = "SELECT * FROM UserInfo WHERE phoneNumber = ?";
...
<script>
    var temp = opener.document.getElementById("phoneChecked");
    if(<%=isFail%> == true){
       alert("중복된 전화번호입니다")
    }
    else{
        alert("사용가능한 전화번호입니다")
        var email =  opener.document.getElementById("phoneNumber");
        email.readOnly = true;
